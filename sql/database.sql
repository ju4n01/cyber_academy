...
--
-- Host: 127.0.0.1    Database: cyber_academy_db
-- ------------------------------------------------------
...
CREATE TABLE `inscripciones` (
  ...
  PRIMARY KEY (`id`),
  KEY `inscripciones_ibfk_1` (`usuario_id`),
  KEY `inscripciones_ibfk_2` (`curso_id`),
...
CREATE TABLE `notas` (
  ...
  PRIMARY KEY (`id`),
  KEY `notas_ibfk_1` (`usuario_id`),
  KEY `notas_ibfk_2` (`curso_id`),
...
CREATE TABLE `usuarios` (
  ...
  KEY `usuarios_ibfk_1` (`tipo_documento_id`),
...
--
-- Dumping routines for database 'cyber_academy_db'
--
...
-- Dump completed on 2024-09-26 20:25:11
